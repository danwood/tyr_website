						...
						<section id="staff" class="clearfix capped-width">
							<div class="inlinebox">
								...
								<div class="clearfix outdented">
									...
									<div class="inlinebox bio row">
										<p class="desc"><!--<img alt="Pam Arneson" class="thumbnail floated-tight" src="img/staff-pam.jpg" />--><span class="person">Pam Arneson</span> <span class="title">(Administrator)</span> is a native of Alameda's West End.  She has 3 daughters who all enjoy performing in musical theater.  Two of them continue to be involved in TYR programs.   It seems that Pam has always been involved in producing fundraising events.  For 7 years, she co-produced Circus for Arts in the Schools, and continues to help produce gala events for the Medical Clown Project.  She has been working for TYR for about a year.  If you have any questions regarding TYR programs, contact Pam at <a href="programs@tomorrowyouthrep.org">programs@tomorrowyouthrep.org</a>.</p>
									</div>
									<div class="inlinebox bio">
										<p class="desc"><span class="person">Dan Wood</span> <span class="title">(Webmaster)</span> built and runs the TYR website with the aid of sophisticated space-age technologies that make sure the website content never goes stale. While not helping TYR, Dan is the proud father of two actors in current and past TYR productions, the landlord of several backyard <a href="http://sweethomealameda.com">honey</a>-yielding beehives, and a partner in <a href="http://www.karelia.com/">Karelia Software</a>.</p>
									</div>
								</div>
								<div class="clearfix outdented">
									<div class="inlinebox">
